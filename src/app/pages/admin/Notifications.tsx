...
export default function Notifications() {
  const notifications = [
    ...
    },
    {
      ...
      message: 'Project Proposal deadline is approaching (May 10, 2026)',
      time: '5 hours ago',
      read: true
    },
    {
      ...
      message: 'Emma Wilson has registered as a student',
      time: '1 day ago',
      read: true
    },
    {
    ...
    },
    {
      ...
      message: '3 students have not submitted their Literature Review',
      time: '2 days ago',
      read: true
    },
    {
      ...
      message: 'Scheduled maintenance on May 8, 2026 from 2:00 AM to 4:00 AM',
      time: '3 days ago',
      read: true
    },
  ];
