          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm mb-6">
              ...
              <form className="space-y-4">
                ...
                <div>
                  <label className="block text-gray-700 mb-2">Research Interests</label>
                  <textarea
                    className="w-full border border-gray-300 rounded-md px-4 py-3 h-24 focus:outline-none focus:border-[#2563a8]"
                    defaultValue="Machine Learning, Artificial Intelligence, Data Science"
                  ></textarea>
                </div>
              </form>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm mb-6">
              <h2 className="text-xl mb-5">Supervision Statistics</h2>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Completed Projects (This Year)</span>
                  <span>8</span>
                </div>
              </div>
            </div>
