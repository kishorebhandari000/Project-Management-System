...
export default function SupervisorStudents() {
  ...
  const StudentRow = ({ allocation }: { allocation: ApiAllocation }) => (
    <div className="flex items-center justify-between gap-4 border border-gray-100 rounded-md px-4 py-3">
            ...
            <>
              ...
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden mb-6">
                ...
                <div className="p-6 space-y-3">
                  ...
                  {current.map((a) => (
                    <StudentRow key={a._id} allocation={a} />
                  ))}
                </div>
              </div>
