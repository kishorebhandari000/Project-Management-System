...
export default function Discussions() {
  ...
  const myDiscussions = discussions.filter(d => d.author === 'Dr. Sarah Johnson' || d.lastReplyBy === 'Dr. Sarah Johnson');
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-5">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Engage with students and colleagues</p>
            </div>
          ...
          {displayDiscussions.length === 0 ? (
            ...
            <div className="space-y-4">
              {displayDiscussions.map((discussion) => (
                <Link
                  key={discussion.id}
                  to={`/supervisor/discussions/${discussion.id}`}
                  className="block"
                >
