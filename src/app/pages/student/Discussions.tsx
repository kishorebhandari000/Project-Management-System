        ...
        <div className="bg-white border-b border-gray-200 px-8 py-5">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Engage with peers and supervisors on your projects</p>
            </div>
        ...
        <div className="p-8">
          {isLoading ? (
            ...
            <div className="bg-white rounded-lg p-12 border border-gray-200 text-center">
              <h3 className="text-xl text-gray-600 mb-2">No approved projects yet</h3>
              <p className="text-gray-500">
                You'll be able to start discussions once you have an approved project allocation.
              </p>
            </div>
          ) : (
            <>
              ...
              <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-600">
                            <span>By <span className="text-gray-800">{d.createdBy.name}</span></span>
                ...
                {display.length === 0 && (
                  <div className="bg-white rounded-lg p-12 border border-gray-200 text-center text-gray-500">
                    No discussions yet. Start one to ask a question or share something with your project team.
                  </div>
                )}
              </div>
            </>
