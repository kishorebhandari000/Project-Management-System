...
function ChatPanel() {
  ...
  return (
    <motion.div
      ...
      className="flex h-[calc(100vh-160px)] bg-white border border-gray-200 rounded-lg overflow-hidden"
    >
      <div className="w-80 border-r border-gray-200 flex flex-col">
        ...
        {loadingContacts ? (
          ...
          <p className="p-5 text-gray-500 text-sm">
            No one to message yet - once you have an approved project, your supervisor will appear here.
          </p>
...
function EmailPanel() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage('Email sent successfully to your supervisor!');
      setRecipientEmail('');
      setSubject('');
      setMessage('');
    } catch (error) {
      // Surfaces the backend's specific message (e.g. "You can only email a
      // supervisor") instead of a generic failure string.
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      >
        <h2 className="text-xl mb-6">Send Email to Supervisor</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-gray-700 mb-2">Supervisor Email *</label>
            <input
              type="email"
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
              <li>Provide clear context about your project or question</li>
              <li>Include all relevant details</li>
              <li>Your supervisor will receive this email directly</li>
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-5">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Chat with your supervisor in real time, or send them an email</p>
            </div>
